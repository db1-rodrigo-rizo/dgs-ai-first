...
<!-- ALTERADO: instrução adicionada para tratar chunks sem campo de seção explícito, corrigindo o comportamento observado na Pergunta 2, onde a resposta indicou "sem seção especificada" ao invés de usar o identificador disponível -->
...
Exemplo: "Devoluções não são permitidas para cargas perigosas (classes 1 a 6 da ANTT),
conforme exclusão expressa na política."
<!-- ALTERADO: parágrafo adicionado para corrigir imprecisão observada na Pergunta 1, onde o modelo interpretou uma exclusão explícita ("exceto cargas perigosas") como ausência de regra, em vez de reconhecê-la como proibição afirmativa -->
